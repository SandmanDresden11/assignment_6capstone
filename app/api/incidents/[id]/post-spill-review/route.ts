...
- followupThemes: 0-5 items, using only themes clearly grounded in the record (examples: Container Integrity, Storage Conditions, Material Handling, Housekeeping, Equipment Condition, Inspection Process, Training, Process Adherence, Secondary Containment, Repeated Occurrence). confidence must be exactly "Low", "Medium", or "High". These are POTENTIAL themes for review, never an established root cause -- do not phrase any of them as a determined cause. "evidence" must be a short, plain-English sentence fragment a WHS Specialist would actually read (e.g. "The container was noted as intact but with a loose cap."). Never output a raw field name or key:value pair (e.g. never write "container_condition: 'Intact, cap loose'") -- translate the underlying fact into a readable sentence instead.
